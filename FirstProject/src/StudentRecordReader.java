//This program prints student records if Full-Time .
//Otherwise nothing is printed to the console
import java.util.Scanner;
public class StudentRecordReader {
	public static void main(String[] args) {
		String fname, lname,status;
		double gpa;
		int hours;//Assuming that hours=credit hours for calculating full time or not		
